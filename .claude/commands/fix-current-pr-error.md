...
1. **Show the error summary to the user**:
   ...
   ```
   [ERROR] GitHub Actions Errors Found
   ────────────────────────────────────────────────────
...
7. **Progress update**:
   ...
   ```
   [FIXED] Fixed [{X}/{N}]: {error_description}
   - File: {file_path}:{line}
...
2. **Generate fix summary**:
   ...
   **URL**: {pr_url}
   ...
   [WARNING] Needs Manual Intervention:
...
3. **Display the summary**:
   ...
   ```
   [COMPLETE] Error Fixing Complete
   ────────────────────────────────────────────────────
