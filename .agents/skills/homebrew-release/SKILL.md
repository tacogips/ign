...
| --- | --- |
| macOS Apple Silicon | `ign-<version>-darwin-arm64.tar.gz` |
| macOS Intel | `ign-<version>-darwin-x64.tar.gz` |
| Linux ARM64 | `ign-<version>-linux-arm64.tar.gz` |
| Linux x86_64 | `ign-<version>-linux-x64.tar.gz` |
